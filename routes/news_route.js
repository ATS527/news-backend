...
const { createNews, createNewsPicture,getNewsWithAdvertisementAndCategorization, getAllNews, getNewsById, updateNews, deleteNews, updateNewsPicture } = require("../controllers/news_controller");
